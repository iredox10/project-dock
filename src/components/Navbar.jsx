        ...
        <div className="flex justify-between items-center h-16 md:h-20">
          ...
          <Link to="/" className="flex-shrink-0 flex items-center gap-2 group">
            <div className={`p-2 rounded-xl transition-all duration-300 ${isScrolled
              ...
              <FaFolderOpen className={`h-6 w-6 md:h-7 md:w-7 transition-colors ${isScrolled ? 'text-white' : 'text-white'
                }`} />
            </div>
          ...
          <div className="hidden md:flex items-center gap-8">
            <NavLink
              to="/"
              className={({ isActive }) => `${isScrolled ? navLinkClasses : desktopNavLinkClasses} ${isActive ? (isScrolled ? activeNavLinkClasses : desktopActiveNavLinkClasses) : ''
                }`}
            >
              Home
            </NavLink>
            ...
            {user ? (
              <div className="relative user-menu-container">
                <button
                  ...
                  className={`flex items-center gap-3 px-4 py-2 rounded-xl transition-all duration-200 ${isScrolled
              ...
              <Link
                to="/signup"
                className={`group flex items-center justify-center gap-2 font-bold px-6 py-3 rounded-xl shadow-lg transition-all duration-200 ${isScrolled
          ...
          <div className="md:hidden flex items-center gap-2">
            {user ? (
              <Link
                to="/dashboard"
                className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all flex items-center gap-2 ${isScrolled
              ...
              <Link
                to="/signup"
                className={`px-4 py-2 rounded-lg text-sm font-bold transition-all ${isScrolled
                    ? 'bg-indigo-600 text-white'
                    : 'bg-white/20 text-white backdrop-blur-sm'
                  }`}
              >
