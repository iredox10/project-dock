...
import { FiGrid, FiBook, FiUser, FiLogOut, FiMenu, FiX, FiShoppingBag, FiHeart, FiArrowLeft } from 'react-icons/fi';
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-t border-gray-100 space-y-1">
        <NavLink
          to="/"
          className="flex items-center gap-3 px-3 py-2 w-full text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors"
        >
